...
const fallbackTestimonials: Testimonial[] = [
  { id: '1', name: 'Priya & Arjun, Kerala', message: 'Luxevibes transformed our wedding in Kerala into a fairy tale. Every single detail was perfection. The best wedding planners we could have chosen!', rating: 5 },
